...
const messages: Record<Language, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.title": "设置",
    "settings.subtitle": "调整 AgentForge 的外观和显示语言。设置会保存在当前设备。",
    "settings.appearance": "外观",
    "settings.appearanceDescription": "选择适合当前环境的界面主题。",
    "settings.language": "语言",
    "settings.languageDescription": "AgentForge 默认使用简体中文，你可以随时切换英文。",
    "settings.dark": "深色",
    "settings.light": "浅色",
  ...
  "en-US": {
    ...
    "settings.subtitle": "Adjust AgentForge appearance and language. Preferences are saved on this device.",
    "settings.appearance": "Appearance",
    "settings.appearanceDescription": "Choose the theme that feels best in your current environment.",
    "settings.language": "Language",
    "settings.languageDescription": "AgentForge defaults to Simplified Chinese. You can switch to English anytime.",
    "settings.dark": "Dark",
